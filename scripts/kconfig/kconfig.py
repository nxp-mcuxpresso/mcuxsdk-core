...
def parse_args():
    ...
    parser.add_argument("header_out_dir",
                        help="Output directory for header file")
    parser.add_argument("kconfig_list_out",
                        help="Output file for list of parsed Kconfig files")
    parser.add_argument("kconfig_header_list_out",
                        help="Output head file")
