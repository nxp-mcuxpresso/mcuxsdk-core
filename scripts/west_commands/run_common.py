...
from build_helpers import find_build_dir, is_mcux_build, load_domains, \
...
def do_run_common_image(command, user_args, user_runner_args, build_dir=None):
    ...
    #     "args": {
    #         "openocd": ["--cmd-load", "flash write_image erase", "--cmd-verify", "verify_image"]
    #     }
    # }
