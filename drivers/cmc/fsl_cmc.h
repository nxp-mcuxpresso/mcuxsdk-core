...
enum _cmc_wakeup_sources
{
    ...
    kCMC_WakeupFromDebugRequest = CMC_CKSTAT_WAKEUP(1U << 1U), /*!< Wakeup source is debug request. */
...
#if (defined(FSL_FEATURE_CMC_HAS_SRIE_SCG_BIT) && (FSL_FEATURE_CMC_HAS_SRIE_SCG_BIT))
    kCMC_SystemClockGenerationResetInterruptEnable = CMC_SRIE_SCG_MASK, /*!< System Clock Generation
                                                                        Reset interrupt enable. */
#endif /* (defined(FSL_FEATURE_CMC_HAS_SRIE_SCG_BIT) && (FSL_FEATURE_CMC_HAS_SRIE_SCG_BIT)) */
...
enum _cmc_system_reset_interrupt_flag
{
    ...
    kCMC_LowPowerAcknowledgeTimeoutResetFlag = CMC_SRIF_LPACK_MASK, /*!< Low Power Acknowledge Timeout
...
enum _cmc_system_sram_arrays
{
    ...
    kCMC_SRAMBank7 = 1U << 7U, /*!< Power off SRAM Bank7,
                               please refer to chip's RM for the corresponding SRAM array. */
    kCMC_SRAMBank8 = 1U << 8U, /*!< Power off SRAM Bank8,
                               please refer to chip's RM for the corresponding SRAM array. */
    kCMC_SRAMBank9 = 1U << 9U, /*!< Power off SRAM Bank9,
                               please refer to chip's RM for the corresponding SRAM array. */
    kCMC_SRAMBank10 = 1U << 10U, /*!< Power off SRAM Bank10,
                               please refer to chip's RM for the corresponding SRAM array.   */
    kCMC_AllSramArrays = (kCMC_SRAMBank0 | kCMC_SRAMBank1 | kCMC_SRAMBank2 |
                        kCMC_SRAMBank3 | kCMC_SRAMBank4 | kCMC_SRAMBank5 |
                        kCMC_SRAMBank6 | kCMC_SRAMBank7 | kCMC_SRAMBank8 |
                        kCMC_SRAMBank9), /*!< Mask of all system SRAM arrays. */
};
...
{
    kCMC_WakeUpReset = CMC_SRS_WAKEUP_MASK, /*!< The reset caused by a wakeup from Power Down or Deep Power Down mode. */
    ...
    kCMC_ResetTimeout = CMC_SRS_RSTACK_MASK, /*!< The reset caused by a timeout or other error condition in the system
                                                reset generation. */
    kCMC_LowPowerAcknowledgeTimeoutReset = CMC_SRS_LPACK_MASK, /*!< The reset caused by a timeout in low
                                                                power mode entry logic. */
    ...
    kCMC_LockUpReset    = CMC_SRS_LOCKUP_MASK, /*!< The reset caused by the ARM core indication of a LOCKUP event. */
...
typedef enum _cmc_clock_mode
{
    ...
    kCMC_GateAllSystemClocksEnterLowPowerMode = 0x0FU /*!< Gate all System clocks, with
                                                        core entering into low power mode. */
} cmc_clock_mode_t;
...
#if (defined(FSL_FEATURE_CMC_HAS_DIER_REG) && FSL_FEATURE_CMC_HAS_DIER_REG)
/*!
 * @brief Gets status flags to indicate if any errors occurred during the reset initialization sequence.
 * 
 * @param base CMC peripheral base address.
 * @return Status flags that indicate errors occurred during the reset initialization sequence.
 */
...
#endif /* FSL_FEATURE_CMC_HAS_DIER_REG */
