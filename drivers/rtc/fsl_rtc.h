 ...
 * Copyright 2016-2019, 2022, 2023, 2025 NXP
 * All rights reserved.
 *
...
/*! @name Driver version */
/*! @{ */
#define FSL_RTC_DRIVER_VERSION (MAKE_VERSION(2, 3, 1)) /*!< Version 2.3.1 */
/*! @} */
...
static inline void RTC_Reset(RTC_Type *base)
{
    ...
    /* 
     * According to ERR008068, after POR, time invalid flag of RTC is set, that is, RTC_SR[TIF]=1.
     * If this flag is not cleared, MCU fails to enter low power mode.
