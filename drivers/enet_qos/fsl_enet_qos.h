...
/* Reuse ENET_QOS driver for EMAC, which is similar */
#define ENET_QOS EMAC

#define ENET_QOS_EMAC_USED_AS_ENET_QOS

#define ENET_QOS_Type      EMAC_Type
#define ENET_QOS_BASE      EMAC_BASE
#define ENET_QOS_BASE_PTRS EMAC_BASE_PTRS
#define ENET_QOS_IRQS      EMAC_IRQS
#define ENETQOS_CLOCKS     EMAC_CLOCKS

#ifdef FSL_FEATURE_EMAC_TX_OFFLOAD_QUEUE_SUPPORT_BITMAP
#define FSL_FEATURE_ENET_QOS_TX_OFFLOAD_QUEUE_SUPPORT_BITMAP FSL_FEATURE_EMAC_TX_OFFLOAD_QUEUE_SUPPORT_BITMAP
#else
#define FSL_FEATURE_ENET_QOS_TX_OFFLOAD_QUEUE_SUPPORT_BITMAP 0xFFFFFFFFU
#endif /* FSL_FEATURE_EMAC_TX_OFFLOAD_QUEUE_SUPPORT_BITMAP */
...
#define ENET_QOS_DMA_CHX_INT_EN_RWTE_MASK                        EMAC_DMA_CHX_INT_EN_RWTE_MASK
#define ENET_QOS_DMA_CHX_INT_EN_FBEE_MASK                        EMAC_DMA_CHX_INT_EN_FBEE_MASK
#define ENET_QOS_DMA_CHX_INT_EN_ETIE_MASK                        EMAC_DMA_CHX_INT_EN_ETIE_MASK
#define ENET_QOS_DMA_CHX_INT_EN_TIE_MASK                         EMAC_DMA_CHX_INT_EN_TIE_MASK
#define ENET_QOS_DMA_CHX_INT_EN_TBUE_MASK                        EMAC_DMA_CHX_INT_EN_TBUE_MASK
#define ENET_QOS_DMA_CHX_INT_EN_RIE_MASK                         EMAC_DMA_CHX_INT_EN_RIE_MASK
#define ENET_QOS_DMA_CHX_INT_EN_ERIE_MASK                        EMAC_DMA_CHX_INT_EN_ERIE_MASK
#define ENET_QOS_MAC_CONFIGURATION_PS                            EMAC_MAC_CONFIGURATION_PS
#define ENET_QOS_MAC_CONFIGURATION_FES                           EMAC_MAC_CONFIGURATION_FES
#define ENET_QOS_MAC_MDIO_ADDRESS_GOC_1                          EMAC_MAC_MDIO_ADDRESS_GOC_1
#define ENET_QOS_MAC_MDIO_ADDRESS_GOC_0                          EMAC_MAC_MDIO_ADDRESS_GOC_0
#define ENET_QOS_MAC_INTERRUPT_ENABLE_TSIE_MASK                  EMAC_MAC_INTERRUPT_ENABLE_TSIE_MASK
#define ENET_QOS_MAC_MDIO_ADDRESS_GB_MASK                        EMAC_MAC_MDIO_ADDRESS_GB_MASK
#define ENET_QOS_MAC_MDIO_DATA_GD_MASK                           EMAC_MAC_MDIO_DATA_GD_MASK
#define ENET_QOS_HIGH_AE_MASK                                    EMAC_HIGH_AE_MASK
#define ENET_QOS_MAC_PACKET_FILTER_PM_MASK                       EMAC_MAC_PACKET_FILTER_PM_MASK
#define ENET_QOS_MAC_FPE_CTRL_STS_EFPE_MASK                      EMAC_MAC_FPE_CTRL_STS_EFPE_MASK
#define ENET_QOS_MTL_FPE_CTRL_STS_PEC_MASK                       EMAC_MTL_FPE_CTRL_STS_PEC_MASK
#define ENET_QOS_MTL_FPE_CTRL_STS_PEC                            EMAC_MTL_FPE_CTRL_STS_PEC
#define ENET_QOS_MAC_PPS_CONTROL_TRGTMODSEL0                     EMAC_MAC_PPS_CONTROL_TRGTMODSEL0
#define ENET_QOS_MAC_PPS_CONTROL_PPSCTRL_PPSCMD                  EMAC_MAC_PPS_CONTROL_PPSCTRL_PPSCMD
#define ENET_QOS_MAC_PPS_CONTROL_PPSEN0                          EMAC_MAC_PPS_CONTROL_PPSEN0
#define ENET_QOS_MAC_PPS0_WIDTH_PPSWIDTH0                        EMAC_MAC_PPS0_WIDTH_PPSWIDTH0
#define ENET_QOS_MAC_PPS0_INTERVAL_PPSINT0                       EMAC_MAC_PPS0_INTERVAL_PPSINT0
#define ENET_QOS_MTL_TXQX_ETS_CTRL_AVALG_MASK                    EMAC_MTL_TXQX_ETS_CTRL_AVALG_MASK
#define ENET_QOS_DMA_MODE_SWR_MASK                               EMAC_DMA_MODE_SWR_MASK
#define ENET_QOS_MAC_CONFIGURATION_DM                            EMAC_MAC_CONFIGURATION_DM
#define ENET_QOS_MAC_CONFIGURATION_S2KP                          EMAC_MAC_CONFIGURATION_S2KP
#define ENET_QOS_MAC_CONFIGURATION_IPG                           EMAC_MAC_CONFIGURATION_IPG
#define ENET_QOS_DMA_CHX_CTRL_PBLx8_MASK                         EMAC_DMA_CHX_CTRL_PBLx8_MASK
#define ENET_QOS_DMA_CHX_TX_CTRL_TxPBL_MASK                      EMAC_DMA_CHX_TX_CTRL_TxPBL_MASK
#define ENET_QOS_DMA_CHX_TX_CTRL_TxPBL                           EMAC_DMA_CHX_TX_CTRL_TxPBL
#define ENET_QOS_DMA_CHX_RX_CTRL_RxPBL_MASK                      EMAC_DMA_CHX_RX_CTRL_RxPBL_MASK
#define ENET_QOS_DMA_CHX_RX_CTRL_RxPBL                           EMAC_DMA_CHX_RX_CTRL_RxPBL
#define ENET_QOS_MTL_TXQX_OP_MODE_TSF_MASK                       EMAC_MTL_TXQX_OP_MODE_TSF_MASK
#define ENET_QOS_MTL_RXQX_OP_MODE_RSF_MASK                       EMAC_MTL_RXQX_OP_MODE_RSF_MASK
#define ENET_QOS_MTL_TXQX_OP_MODE_FTQ_MASK                       EMAC_MTL_TXQX_OP_MODE_FTQ_MASK
#define ENET_QOS_MTL_RXQX_OP_MODE_FUP_MASK                       EMAC_MTL_RXQX_OP_MODE_FUP_MASK
#define ENET_QOS_MTL_RXQX_OP_MODE_RFD                            EMAC_MTL_RXQX_OP_MODE_RFD
#define ENET_QOS_MTL_RXQX_OP_MODE_RFA                            EMAC_MTL_RXQX_OP_MODE_RFA
#define ENET_QOS_MTL_RXQX_OP_MODE_EHFC_MASK                      EMAC_MTL_RXQX_OP_MODE_EHFC_MASK
#define ENET_QOS_MTL_TXQX_OP_MODE_TQS                            EMAC_MTL_TXQX_OP_MODE_TQS
#define ENET_QOS_MTL_RXQX_OP_MODE_RQS                            EMAC_MTL_RXQX_OP_MODE_RQS
#define ENET_QOS_MTL_TXQX_OP_MODE_TXQEN                          EMAC_MTL_TXQX_OP_MODE_TXQEN
#define ENET_QOS_MTL_OPERATION_MODE_SCHALG                       EMAC_MTL_OPERATION_MODE_SCHALG
#define ENET_QOS_MTL_OPERATION_MODE_RAA                          EMAC_MTL_OPERATION_MODE_RAA
#define ENET_QOS_MTL_RXQ_DMA_MAP0_Q0MDMACH_MASK                  EMAC_MTL_RXQ_DMA_MAP0_Q0MDMACH_MASK
#define ENET_QOS_MTL_RXQ_DMA_MAP0_Q0MDMACH                       EMAC_MTL_RXQ_DMA_MAP0_Q0MDMACH
#define ENET_QOS_MAC_PACKET_FILTER_PR                            EMAC_MAC_PACKET_FILTER_PR
#define ENET_QOS_MAC_PACKET_FILTER_DBF                           EMAC_MAC_PACKET_FILTER_DBF
#define ENET_QOS_MAC_PACKET_FILTER_PM                            EMAC_MAC_PACKET_FILTER_PM
#define ENET_QOS_MAC_PACKET_FILTER_HMC                           EMAC_MAC_PACKET_FILTER_HMC
#define ENET_QOS_MAC_RX_FLOW_CTRL_RFE_MASK                       EMAC_MAC_RX_FLOW_CTRL_RFE_MASK
#define ENET_QOS_MAC_RX_FLOW_CTRL_UP_MASK                        EMAC_MAC_RX_FLOW_CTRL_UP_MASK
#define ENET_QOS_MAC_TX_FLOW_CTRL_Q_PT                           EMAC_MAC_TX_FLOW_CTRL_Q_PT
#define ENET_QOS_MAC_CONFIGURATION_IPC                           EMAC_MAC_CONFIGURATION_IPC
#define ENET_QOS_MAC_TXQ_PRTY_MAP0_PSTQ0_MASK                    EMAC_MAC_TXQ_PRTY_MAP0_PSTQ0_MASK
#define ENET_QOS_MAC_TXQ_PRTY_MAP0_PSTQ0                         EMAC_MAC_TXQ_PRTY_MAP0_PSTQ0
#define ENET_QOS_MAC_RXQ_CTRL_COUNT                              EMAC_MAC_RXQ_CTRL_COUNT
#define ENET_QOS_MAC_RXQ_CTRL_PSRQ0_MASK                         EMAC_MAC_RXQ_CTRL_PSRQ0_MASK
#define ENET_QOS_MAC_RXQ_CTRL_PSRQ0                              EMAC_MAC_RXQ_CTRL_PSRQ0
#define ENET_QOS_MAC_RXQ_CTRL_RXQ0EN                             EMAC_MAC_RXQ_CTRL_RXQ0EN
#define ENET_QOS_MAC_RXQ_CTRL_AVCPQ_MASK                         EMAC_MAC_RXQ_CTRL_AVCPQ_MASK
#define ENET_QOS_MAC_RXQ_CTRL_AVCPQ                              EMAC_MAC_RXQ_CTRL_AVCPQ
#define ENET_QOS_MAC_RXQ_CTRL_TACPQE_MASK                        EMAC_MAC_RXQ_CTRL_TACPQE_MASK
#define ENET_QOS_MAC_RXQ_CTRL_PTPQ_MASK                          EMAC_MAC_RXQ_CTRL_PTPQ_MASK
#define ENET_QOS_MAC_RXQ_CTRL_PTPQ                               EMAC_MAC_RXQ_CTRL_PTPQ
#define ENET_QOS_MAC_RXQ_CTRL_UPQ_MASK                           EMAC_MAC_RXQ_CTRL_UPQ_MASK
#define ENET_QOS_MAC_RXQ_CTRL_UPQ                                EMAC_MAC_RXQ_CTRL_UPQ
#define ENET_QOS_MAC_RXQ_CTRL_MCBCQ_MASK                         EMAC_MAC_RXQ_CTRL_MCBCQ_MASK
#define ENET_QOS_MAC_RXQ_CTRL_MCBCQ                              EMAC_MAC_RXQ_CTRL_MCBCQ
#define ENET_QOS_MAC_RXQ_CTRL_MCBCQEN_MASK                       EMAC_MAC_RXQ_CTRL_MCBCQEN_MASK
#define ENET_QOS_DMA_CHX_TXDESC_LIST_ADDR_TDESLA_MASK            EMAC_DMA_CHX_TXDESC_LIST_ADDR_TDESLA_MASK
#define ENET_QOS_DMA_CHX_TXDESC_TAIL_PTR_TDTP_MASK               EMAC_DMA_CHX_TXDESC_TAIL_PTR_TDTP_MASK
#define ENET_QOS_DMA_CHX_TXDESC_RING_LENGTH_TDRL_MASK            EMAC_DMA_CHX_TXDESC_RING_LENGTH_TDRL_MASK
#define ENET_QOS_DMA_CHX_RXDESC_LIST_ADDR_RDESLA_MASK            EMAC_DMA_CHX_RXDESC_LIST_ADDR_RDESLA_MASK
#define ENET_QOS_DMA_CHX_RXDESC_TAIL_PTR_RDTP_MASK               EMAC_DMA_CHX_RXDESC_TAIL_PTR_RDTP_MASK
#define ENET_QOS_DMA_CHX_RXDESC_RING_LENGTH_RDRL_MASK            EMAC_DMA_CHX_RXDESC_RING_LENGTH_RDRL_MASK
#define ENET_QOS_DMA_CHX_RX_CTRL_RBSZ_13_y_MASK                  EMAC_DMA_CHX_RX_CTRL_RBSZ_13_y_MASK
#define ENET_QOS_DMA_CHX_RX_CTRL_RBSZ_13_y                       EMAC_DMA_CHX_RX_CTRL_RBSZ_13_y
#define ENET_QOS_MAC_TIMESTAMP_CONTROL_TSCFUPDT_MASK             EMAC_MAC_TIMESTAMP_CONTROL_TSCFUPDT_MASK
#define ENET_QOS_MAC_TIMESTAMP_CONTROL_TSENA_MASK                EMAC_MAC_TIMESTAMP_CONTROL_TSENA_MASK
#define ENET_QOS_MAC_TIMESTAMP_CONTROL_TSIPV4ENA_MASK            EMAC_MAC_TIMESTAMP_CONTROL_TSIPV4ENA_MASK
#define ENET_QOS_MAC_TIMESTAMP_CONTROL_TSIPV6ENA_MASK            EMAC_MAC_TIMESTAMP_CONTROL_TSIPV6ENA_MASK
#define ENET_QOS_MAC_TIMESTAMP_CONTROL_TSENALL_MASK              EMAC_MAC_TIMESTAMP_CONTROL_TSENALL_MASK
#define ENET_QOS_MAC_TIMESTAMP_CONTROL_TSEVNTENA_MASK            EMAC_MAC_TIMESTAMP_CONTROL_TSEVNTENA_MASK
#define ENET_QOS_MAC_TIMESTAMP_CONTROL_SNAPTYPSEL_MASK           EMAC_MAC_TIMESTAMP_CONTROL_SNAPTYPSEL_MASK
#define ENET_QOS_MAC_TIMESTAMP_CONTROL_TSCTRLSSR                 EMAC_MAC_TIMESTAMP_CONTROL_TSCTRLSSR
#define ENET_QOS_MAC_TIMESTAMP_CONTROL_TSVER2ENA_MASK            EMAC_MAC_TIMESTAMP_CONTROL_TSVER2ENA_MASK
#define ENET_QOS_MAC_TIMESTAMP_CONTROL_TSIPENA_MASK              EMAC_MAC_TIMESTAMP_CONTROL_TSIPENA_MASK
#define ENET_QOS_MAC_SYSTEM_TIME_NANOSECONDS_TSSS_MASK           EMAC_MAC_SYSTEM_TIME_NANOSECONDS_TSSS_MASK
#define ENET_QOS_MAC_TIMESTAMP_CONTROL_TSINIT_MASK               EMAC_MAC_TIMESTAMP_CONTROL_TSINIT_MASK
#define ENET_QOS_MAC_SUB_SECOND_INCREMENT_SSINC                  EMAC_MAC_SUB_SECOND_INCREMENT_SSINC
#define ENET_QOS_MAC_SUB_SECOND_INCREMENT_SNSINC                 EMAC_MAC_SUB_SECOND_INCREMENT_SNSINC
#define ENET_QOS_MAC_TIMESTAMP_CONTROL_TSCTRLSSR_MASK            EMAC_MAC_TIMESTAMP_CONTROL_TSCTRLSSR_MASK
#define ENET_QOS_DMA_CHX_TX_CTRL_ST_MASK                         EMAC_DMA_CHX_TX_CTRL_ST_MASK
#define ENET_QOS_MTL_TXQX_DBG_TXQSTS_MASK                        EMAC_MTL_TXQX_DBG_TXQSTS_MASK
#define ENET_QOS_MTL_TXQX_DBG_PTXQ_MASK                          EMAC_MTL_TXQX_DBG_PTXQ_MASK
#define ENET_QOS_MAC_CONFIGURATION_TE_MASK                       EMAC_MAC_CONFIGURATION_TE_MASK
#define ENET_QOS_MAC_CONFIGURATION_RE_MASK                       EMAC_MAC_CONFIGURATION_RE_MASK
#define ENET_QOS_DMA_CHX_RX_CTRL_SR_MASK                         EMAC_DMA_CHX_RX_CTRL_SR_MASK
#define ENET_QOS_DMA_CHX_INT_EN_AIE_MASK                         EMAC_DMA_CHX_INT_EN_AIE_MASK
#define ENET_QOS_DMA_CHX_INT_EN_NIE_MASK                         EMAC_DMA_CHX_INT_EN_NIE_MASK
#define ENET_QOS_MAC_CONFIGURATION_DM_MASK                       EMAC_MAC_CONFIGURATION_DM_MASK
#define ENET_QOS_MAC_CONFIGURATION_PS_MASK                       EMAC_MAC_CONFIGURATION_PS_MASK
#define ENET_QOS_MAC_CONFIGURATION_FES_MASK                      EMAC_MAC_CONFIGURATION_FES_MASK
#define ENET_QOS_MAC_MDIO_ADDRESS_CR                             EMAC_MAC_MDIO_ADDRESS_CR
#define ENET_QOS_MAC_MDIO_ADDRESS_CR_MASK                        EMAC_MAC_MDIO_ADDRESS_CR_MASK
#define ENET_QOS_MAC_MDIO_ADDRESS_PA                             EMAC_MAC_MDIO_ADDRESS_PA
#define ENET_QOS_MAC_MDIO_ADDRESS_RDA                            EMAC_MAC_MDIO_ADDRESS_RDA
#define ENET_QOS_MAC_MDIO_ADDRESS_C45E_MASK                      EMAC_MAC_MDIO_ADDRESS_C45E_MASK
#define ENET_QOS_MAC_MDIO_DATA_RA                                EMAC_MAC_MDIO_DATA_RA
#define ENET_QOS_MTL_OPERATION_MODE_FRPE_MASK                    EMAC_MTL_OPERATION_MODE_FRPE_MASK
#define ENET_QOS_MTL_RXP_CONTROL_STATUS_RXPI_MASK                EMAC_MTL_RXP_CONTROL_STATUS_RXPI_MASK
#define ENET_QOS_MAC_SYSTEM_TIME_HIGHER_WORD_SECONDS_TSHWR_MASK  EMAC_MAC_SYSTEM_TIME_HIGHER_WORD_SECONDS_TSHWR_MASK
#define ENET_QOS_MAC_SYSTEM_TIME_SECONDS_UPDATE_TSS_MASK         EMAC_MAC_SYSTEM_TIME_SECONDS_UPDATE_TSS_MASK
#define ENET_QOS_MAC_SYSTEM_TIME_NANOSECONDS_UPDATE_ADDSUB_MASK  EMAC_MAC_SYSTEM_TIME_NANOSECONDS_UPDATE_ADDSUB_MASK
#define ENET_QOS_MAC_SYSTEM_TIME_NANOSECONDS_UPDATE_TSSS         EMAC_MAC_SYSTEM_TIME_NANOSECONDS_UPDATE_TSSS
#define ENET_QOS_MAC_SYSTEM_TIME_NANOSECONDS_UPDATE_TSSS_MASK    EMAC_MAC_SYSTEM_TIME_NANOSECONDS_UPDATE_TSSS_MASK
#define ENET_QOS_MAC_TIMESTAMP_CONTROL_TSUPDT_MASK               EMAC_MAC_TIMESTAMP_CONTROL_TSUPDT_MASK
#define ENET_QOS_MAC_TIMESTAMP_CONTROL_TSADDREG_MASK             EMAC_MAC_TIMESTAMP_CONTROL_TSADDREG_MASK
#define ENET_QOS_MAC_PPS0_TARGET_TIME_NANOSECONDS_TRGTBUSY0_MASK EMAC_MAC_PPS0_TARGET_TIME_NANOSECONDS_TRGTBUSY0_MASK
#define ENET_QOS_MAC_PPS0_TARGET_TIME_NANOSECONDS_TTSL0          EMAC_MAC_PPS0_TARGET_TIME_NANOSECONDS_TTSL0
#define ENET_QOS_MAC_PPS0_TARGET_TIME_SECONDS_TSTRH0             EMAC_MAC_PPS0_TARGET_TIME_SECONDS_TSTRH0
#define ENET_QOS_MTL_EST_GCL_CONTROL_ADDR                        EMAC_MTL_EST_GCL_CONTROL_ADDR
#define ENET_QOS_MTL_EST_GCL_CONTROL_SRWO                        EMAC_MTL_EST_GCL_CONTROL_SRWO
#define ENET_QOS_MTL_EST_GCL_CONTROL_DBGM                        EMAC_MTL_EST_GCL_CONTROL_DBGM
#define ENET_QOS_MTL_EST_GCL_CONTROL_GCRR                        EMAC_MTL_EST_GCL_CONTROL_GCRR
#define ENET_QOS_MTL_EST_GCL_CONTROL_R1W0                        EMAC_MTL_EST_GCL_CONTROL_R1W0
#define ENET_QOS_MTL_EST_GCL_CONTROL_SRWO_MASK                   EMAC_MTL_EST_GCL_CONTROL_SRWO_MASK
#define ENET_QOS_MTL_EST_GCL_CONTROL_ERR0_MASK                   EMAC_MTL_EST_GCL_CONTROL_ERR0_MASK
...
#define ENET_QOS_MTL_RXP_INDIRECT_ACC_CONTROL_STATUS_ADDR       EMAC_MTL_RXP_INDIRECT_ACC_CONTROL_STATUS_ADDR
#define ENET_QOS_MTL_RXP_INDIRECT_ACC_CONTROL_STATUS_WRRDN_MASK EMAC_MTL_RXP_INDIRECT_ACC_CONTROL_STATUS_WRRDN_MASK
#define ENET_QOS_DMA_INTERRUPT_STATUS_DC0IS_MASK                EMAC_DMA_INTERRUPT_STATUS_DC0IS_MASK
#define ENET_QOS_DMA_CHX_STAT_RI_MASK                           EMAC_DMA_CHX_STAT_RI_MASK
#define ENET_QOS_DMA_CHX_STAT_NIS_MASK                          EMAC_DMA_CHX_STAT_NIS_MASK
#define ENET_QOS_DMA_CHX_STAT_TI_MASK                           EMAC_DMA_CHX_STAT_TI_MASK
#define ENET_QOS_DMA_INTERRUPT_STATUS_DC1IS_MASK                EMAC_DMA_INTERRUPT_STATUS_DC1IS_MASK
#define ENET_QOS_DMA_INTERRUPT_STATUS_MACIS_MASK                EMAC_DMA_INTERRUPT_STATUS_MACIS_MASK
#define ENET_QOS_MAC_INTERRUPT_STATUS_TSIS_MASK                 EMAC_MAC_INTERRUPT_STATUS_TSIS_MASK
#define MAC_MMC_RX_INTERRUPT_MASK                               MMC_RX_INTERRUPT_MASK
#define MAC_MMC_TX_INTERRUPT_MASK                               MMC_TX_INTERRUPT_MASK
#define MAC_MMC_FPE_RX_INTERRUPT_MASK                           MMC_FPE_RX_INTERRUPT_MASK
#define MAC_MMC_FPE_TX_INTERRUPT_MASK                           MMC_FPE_TX_INTERRUPT_MASK
#define MAC_RX_PACKETS_COUNT_GOOD_BAD                           RX_PACKETS_COUNT_GOOD_BAD
#define MAC_RX_CRC_ERROR_PACKETS                                RX_CRC_ERROR_PACKETS
#define MAC_RX_ALIGNMENT_ERROR_PACKETS                          RX_ALIGNMENT_ERROR_PACKETS
#define MAC_RX_LENGTH_ERROR_PACKETS                             RX_LENGTH_ERROR_PACKETS
#define MAC_RX_FIFO_OVERFLOW_PACKETS                            RX_FIFO_OVERFLOW_PACKETS
#define MAC_TX_PACKET_COUNT_GOOD_BAD                            TX_PACKET_COUNT_GOOD_BAD
#define MAC_TX_UNDERFLOW_ERROR_PACKETS                          TX_UNDERFLOW_ERROR_PACKETS
#define MAC_TX_PACKET_COUNT_GOOD                                TX_PACKET_COUNT_GOOD
#define MAC_RX_BROADCAST_PACKETS_GOOD                           RX_BROADCAST_PACKETS_GOOD
#define MAC_TX_MULTICAST_PACKETS_GOOD                           TX_MULTICAST_PACKETS_GOOD
#define MAC_TX_BROADCAST_PACKETS_GOOD                           TX_BROADCAST_PACKETS_GOOD
#define MAC_RX_MULTICAST_PACKETS_GOOD                           RX_MULTICAST_PACKETS_GOOD
#define MAC_TX_PAUSE_PACKETS                                    TX_PAUSE_PACKETS
#define MAC_RX_PAUSE_PACKETS                                    RX_PAUSE_PACKETS
#ifdef TX_LPI_TRAN_CNTR
#define MAC_TX_LPI_TRAN_CNTR TX_LPI_TRAN_CNTR
#endif /* TX_LPI_TRAN_CNTR */
#ifdef RX_LPI_TRAN_CNTR
#define MAC_RX_LPI_TRAN_CNTR RX_LPI_TRAN_CNTR
#endif /* RX_LPI_TRAN_CNTR */
#define MAC_RX_UNDERSIZE_PACKETS_GOOD           RX_UNDERSIZE_PACKETS_GOOD
#define MAC_RX_OVERSIZE_PACKETS_GOOD            RX_OVERSIZE_PACKETS_GOOD
#define MAC_RX_RUNT_ERROR_PACKETS               RX_RUNT_ERROR_PACKETS
#define MAC_RX_64OCTETS_PACKETS_GOOD_BAD        RX_64OCTETS_PACKETS_GOOD_BAD
#define MAC_RX_65TO127OCTETS_PACKETS_GOOD_BAD   RX_65TO127OCTETS_PACKETS_GOOD_BAD
#define MAC_RX_128TO255OCTETS_PACKETS_GOOD_BAD  RX_128TO255OCTETS_PACKETS_GOOD_BAD
#define MAC_RX_256TO511OCTETS_PACKETS_GOOD_BAD  RX_256TO511OCTETS_PACKETS_GOOD_BAD
#define MAC_RX_512TO1023OCTETS_PACKETS_GOOD_BAD RX_512TO1023OCTETS_PACKETS_GOOD_BAD
#define MAC_RX_1024TOMAXOCTETS_PACKETS_GOOD_BAD RX_1024TOMAXOCTETS_PACKETS_GOOD_BAD
#define MAC_TX_64OCTETS_PACKETS_GOOD_BAD        TX_64OCTETS_PACKETS_GOOD_BAD
#define MAC_TX_65TO127OCTETS_PACKETS_GOOD_BAD   TX_65TO127OCTETS_PACKETS_GOOD_BAD
#define MAC_TX_128TO255OCTETS_PACKETS_GOOD_BAD  TX_128TO255OCTETS_PACKETS_GOOD_BAD
#define MAC_TX_256TO511OCTETS_PACKETS_GOOD_BAD  TX_256TO511OCTETS_PACKETS_GOOD_BAD
#define MAC_TX_512TO1023OCTETS_PACKETS_GOOD_BAD TX_512TO1023OCTETS_PACKETS_GOOD_BAD
#define MAC_TX_1024TOMAXOCTETS_PACKETS_GOOD_BAD TX_1024TOMAXOCTETS_PACKETS_GOOD_BAD
#define MAC_MMC_TX_FPE_FRAGMENT_CNTR            MMC_TX_FPE_FRAGMENT_CNTR
#define MAC_MMC_TX_HOLD_REQ_CNTR                MMC_TX_HOLD_REQ_CNTR
#define MAC_MMC_RX_PACKET_ASSEMBLY_ERR_CNTR     MMC_RX_PACKET_ASSEMBLY_ERR_CNTR
#define MAC_MMC_RX_PACKET_SMD_ERR_CNTR          MMC_RX_PACKET_SMD_ERR_CNTR
#define MAC_MMC_RX_PACKET_ASSEMBLY_OK_CNTR      MMC_RX_PACKET_ASSEMBLY_OK_CNTR
#define MAC_MMC_RX_FPE_FRAGMENT_CNTR            MMC_RX_FPE_FRAGMENT_CNTR
#define MAC_PMT_CONTROL_STATUS                  MMC_RX_FPE_FRAGMENT_CNTR

#define ENET_QOS_MAC_FPE_CTRL_STS_TRSP_MASK      EMAC_MAC_FPE_CTRL_STS_TRSP_MASK
#define ENET_QOS_MAC_FPE_CTRL_STS_TVER_MASK      EMAC_MAC_FPE_CTRL_STS_TVER_MASK
#define ENET_QOS_MAC_FPE_CTRL_STS_RRSP_MASK      EMAC_MAC_FPE_CTRL_STS_RRSP_MASK
#define ENET_QOS_MAC_FPE_CTRL_STS_RVER_MASK      EMAC_MAC_FPE_CTRL_STS_RVER_MASK
#define ENET_QOS_MAC_INTERRUPT_STATUS_FPEIS_MASK EMAC_MAC_INTERRUPT_STATUS_FPEIS_MASK
#define ENET_QOS_MAC_INTERRUPT_ENABLE_FPEIE_MASK EMAC_MAC_INTERRUPT_ENABLE_FPEIE_MASK
#define ENET_QOS_MTL_FPE_CTRL_STS_AFSZ_MASK      EMAC_MTL_FPE_CTRL_STS_AFSZ_MASK
#define ENET_QOS_MTL_FPE_CTRL_STS_AFSZ           EMAC_MTL_FPE_CTRL_STS_AFSZ
#define ENET_QOS_MTL_FPE_CTRL_STS_PEC_SHIFT      EMAC_MTL_FPE_CTRL_STS_PEC_SHIFT
#define ENET_QOS_MTL_FPE_ADVANCE_HADV_MASK       EMAC_MTL_FPE_ADVANCE_HADV_MASK
#define ENET_QOS_MTL_FPE_ADVANCE_HADV_SHIFT      EMAC_MTL_FPE_ADVANCE_HADV_SHIFT
#define ENET_QOS_MTL_FPE_ADVANCE_RADV_MASK       EMAC_MTL_FPE_ADVANCE_RADV_MASK
#define ENET_QOS_MTL_FPE_ADVANCE_RADV_SHIFT      EMAC_MTL_FPE_ADVANCE_RADV_SHIFT
#define ENET_QOS_MTL_FPE_CTRL_STS_HRS_MASK       EMAC_MTL_FPE_CTRL_STS_HRS_MASK
#define ENET_QOS_MTL_FPE_CTRL_STS_AFSZ_MASK      EMAC_MTL_FPE_CTRL_STS_AFSZ_MASK
#define ENET_QOS_MTL_FPE_CTRL_STS_AFSZ_SHIFT     EMAC_MTL_FPE_CTRL_STS_AFSZ_SHIFT
#define ENET_QOS_MAC_FPE_CTRL_STS_SRSP_MASK      EMAC_MAC_FPE_CTRL_STS_SRSP_MASK
#define ENET_QOS_MAC_FPE_CTRL_STS_SVER_MASK      EMAC_MAC_FPE_CTRL_STS_SVER_MASK

#define ENET_QOS_MTL_RXP_CONTROL_STATUS_NVE      EMAC_MTL_RXP_CONTROL_STATUS_NVE
#define ENET_QOS_MTL_RXP_CONTROL_STATUS_NPE      EMAC_MTL_RXP_CONTROL_STATUS_NPE
#define ENET_QOS_MTL_RXP_CONTROL_STATUS_NPE_MASK EMAC_MTL_RXP_CONTROL_STATUS_NPE_MASK
#define ENET_QOS_MTL_RXP_CONTROL_STATUS_NVE_MASK EMAC_MTL_RXP_CONTROL_STATUS_NVE_MASK
