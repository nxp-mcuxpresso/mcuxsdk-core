  ...
  if (MCUX_SDK_CMAKE_PACKAGE)
    ...
    if (DEFINED project_board_port_path)
      if (DEFINED core_id)
        ...
        list(APPEND mex_file_search_path_list ${full_project_port_path})
        cmake_path(APPEND shared_project_port_path ${SdkRootDirPath} ${project_board_port_path})
        list(APPEND mex_file_search_path_list ${shared_project_port_path})
      else()
        cmake_path(APPEND full_project_port_path ${SdkRootDirPath} ${project_board_port_path})
        cmake_path(APPEND mex_file_search_path_list ${full_project_port_path})
      endif()
      ...
      set(find_mex_file FALSE)
      foreach(mex_file_search_path ${mex_file_search_path_list})
        ...
        if(mex_count EQUAL 0)
          ...
          set(find_mex_file TRUE)
          break()
        endif()
      endforeach()

      if(DEFINED MCUXPRESSO_CONFIG_TOOL_MEX_PATH AND NOT find_mex_file)
