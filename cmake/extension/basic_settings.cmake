...
if(DEFINED board)
  ...
  if(NOT EXISTS ${board_variable_path})
    log_fatal("Board variable file ${board_variable_path} does not exist, please provide the board variable cmake file or check whether board ${board} has been supported or not, make sure it is not a typo" ${CMAKE_CURRENT_LIST_FILE} ${CMAKE_CURRENT_LIST_LINE})
  endif()
