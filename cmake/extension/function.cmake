...
function(mcux_add_source)
  ...
  foreach(item ${__SOURCES})
    ...
    foreach(source_abs_path ${files})
        ...
        if (__PREINCLUDE)
          set(pre_flag "")
          # MCUX-81203: Need quotes for path containing space
          set(source_abs_path_s "\"${source_abs_path}\"")
          if(${CONFIG_TOOLCHAIN} STREQUAL "iar")
            set(pre_flag "--preinclude ${source_abs_path_s}")
            set(as_pre_flag "-P ${source_abs_path_s}")
          elseif(${CONFIG_TOOLCHAIN} STREQUAL "armgcc")
            set(pre_flag "-include ${source_abs_path_s}")
