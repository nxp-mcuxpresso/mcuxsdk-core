...
if(NOT DEFINED SdkRootDirPath)
  message(FATAL_ERROR "SdkRootDirPath not set")
endif()
...
message("  all          - Build a mcuxsdk application")
message("  run          - Build a mcuxsdk application and run it if the board supports emulation")
...
message("  pahole       - Report struct padding (requires the pahole program in Linux)")
message("  puncover     - Local web server to view RAM, ROM and stack usage (requires 'pip install -U puncover' and armgcc toolchain)")
...
message("  guiproject   - Create IDE GUI application")
message("  standalone_project")
message("               - Collect and copy all the components and example self configurations and sources into an individual folder")
