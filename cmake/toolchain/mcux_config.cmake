...
elseif(${LIBRARY_TYPE} STREQUAL "REDLIB")
    if(${DEBUG_CONSOLE} STREQUAL "SEMIHOST")
        set(TARGET_LINK_SYSTEM_LIBRARIES "-lcr_semihost ${TARGET_LINK_SYSTEM_LIBRARIES}" PARENT_SCOPE)
    elseif(${DEBUG_CONSOLE} STREQUAL "SEMIHOST_NF")
        set(TARGET_LINK_SYSTEM_LIBRARIES "-lcr_semihost_nf ${TARGET_LINK_SYSTEM_LIBRARIES}" PARENT_SCOPE)
    elseif(${DEBUG_CONSOLE} STREQUAL "SEMIHOST_MB")
        set(TARGET_LINK_SYSTEM_LIBRARIES "-lcr_semihost_mb ${TARGET_LINK_SYSTEM_LIBRARIES}" PARENT_SCOPE)
    elseif(${DEBUG_CONSOLE} STREQUAL "SEMIHOST_MB_NF")
        set(TARGET_LINK_SYSTEM_LIBRARIES "-lcr_semihost_mb_nf ${TARGET_LINK_SYSTEM_LIBRARIES}" PARENT_SCOPE)
    elseif(${DEBUG_CONSOLE} STREQUAL "UART" OR ${DEBUG_CONSOLE} STREQUAL "NOHOST_NF" OR ${DEBUG_CONSOLE} STREQUAL "NOHOST")
        set(TARGET_LINK_SYSTEM_LIBRARIES "-lcr_nohost_nf" ${TARGET_LINK_SYSTEM_LIBRARIES} PARENT_SCOPE)
    endif()
endif()
endfunction()
